...
WOMC = USDMM.WOMC(
    ...
    path_results = 'results_V7', # STR -> file where we want to save the results
    name_save='_V7', # STR -> pos fixed name for the results saved
    seed = 2, #INT -> seed for reproducibilit
    ...
    early_stop_round_w = 5 #INT -> max number of epochs without changes in the windows lattice
)
WOMC.fit()
