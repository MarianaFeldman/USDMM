...
class WOMC_JAX:
    ...
    def __init__(self, nlayer, wlen, train_size, val_size, test_size, error_type,
        ...
        filename = f'./data/x_classification/train.txt'
        self.jax_train = jnp.load(filename, allow_pickle=True)
        filename = f'./data/y_classification/train.txt'
        self.jax_ytrain = jnp.load(filename, allow_pickle=True)

        filename = f'./data/x_classification/val.txt'
        self.jax_val = jnp.load(filename, allow_pickle=True)
        filename = f'./data/y_classification/val.txt'
        self.jax_yval = jnp.load(filename, allow_pickle=True)

        filename = f'./data/x_classification/test.txt'
        self.jax_test = jnp.load(filename, allow_pickle=True)
        filename = f'./data/y_classification/test.txt'
        self.jax_ytest = jnp.load(filename, allow_pickle=True)
        ...
        path_name = f'/app/output/{path_results}'
        isExist = os.path.exists(path_name)
        if not isExist:
            os.makedirs(path_name)
        path_name = f'/app/output/{path_results}/run'
        isExist = os.path.exists(path_name)
        if not isExist:
            os.makedirs(path_name)
        path_name = f'/app/output/{path_results}/trained'
        isExist = os.path.exists(path_name)
        if not isExist:
            os.makedirs(path_name)
...
class WOMC_DATA:
    ...
    def __init__(self, **kwargs):
        ...
        self.data = kwargs
        with open('./data/parameters_classification.pkl', 'wb') as file:
