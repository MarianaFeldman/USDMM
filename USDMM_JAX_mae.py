...
# Calcular o erro
def MSE(true,pred):
  pred_img = pred[-1]#[:, WOMC.ci_h, WOMC.ci_w]
  pred_ = jnp.where(pred_img == -1, 0, pred_img)
...
def fit():
    ...
    return error_ep, time_min, error_train, error_val, error_test, W_min, joint_min, joint_shape_min
