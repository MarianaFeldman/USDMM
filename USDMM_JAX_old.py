...
def fit():
    ...
    pickle.dump(WOMC.w_hist, open(f'/{work_directory}/output/{WOMC.path_results}/W_hist{WOMC.name_save}.txt', 'wb'))
    pickle.dump(error_ep, open(f'/{work_directory}/output/{WOMC.path_results}/error_ep_w{WOMC.name_save}.txt', 'wb'))
    pickle.dump(WOMC.error_ep_f, open(f'/{work_directory}/output/{WOMC.path_results}/error_ep_f{WOMC.name_save}.txt', 'wb'))
